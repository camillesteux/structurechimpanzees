...
scen_files <- list("verus"="val_rapport_verus_c7w050_eb.csv", "ellioti"="val_ellioti_Kotorep5_c7eb.csv", "troglodytes"="val_rapport_troglo_c8w050_eb.csv",
                   "schweinfurthii"="val_rapport_schwein_c7w050_eb.csv")
...
#ggsave(filename =  "PAPER_valn.png", width = 10, height = 7, dpi = 300, units = "cm", device='png') 


### N (main text, Figure 4B)
ggplot(data = dataframe_N) +
  geom_violin(aes(x=sub, y = N, fill=sub, color=sub), draw_quantiles = c(0.25, 0.5, 0.75), show.legend = FALSE) +
  geom_point(aes(x=sub, y = N, fill=sub, color=sub), show.legend = FALSE, size=0.8) +
  geom_point(aes(x = sub, y=val), color = 'black', size = 1) +
...
#ggsave(filename =  "PAPER_valCG_V.png", width = 10, height = 6, dpi = 300, units = "cm", device='png') 
...
#ggsave(filename =  "PAPER_valCG_NC2.png", width = 10, height = 6, dpi = 300, units = "cm", device='png') 
...
#ggsave(filename =  "PAPER_valCG_T.png", width = 10, height = 7, dpi = 300, units = "cm", device='png') 
...
#ggsave(filename =  "PAPER_valCG_E.png", width = 10, height = 7, dpi = 300, units = "cm", device='png') 
