...
gentime = 25
mut = 1.5e-8
ind = ["9668_Bosco", "9730_Donald", "A956_Jimmie", "Clint", "X00100_Koby"]

for i in ind:
    for w in [0.5]:
            h_inference_parameters = InferenceParameters(
                data_source = "".join(['~/gape-psmc/FINAL_CLEAN_Pan_troglodytes_verus-', i, '.psmc']),
                ...
                distance_computation_interval = (2e4/gentime, 2e7/gentime),
            ...
            h_settings = Settings(
                ...
                custom_filename_tag = "".join(['c7ebcut_', i]),
                output_directory = '~/snif/Chimps/verus/verus_all',
