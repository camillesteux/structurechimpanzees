...
for i in [1, 2, 3, 4, 5]:
    for w in [0.5]:
        h_inference_parameters = InferenceParameters(
            data_source = '~/230322-130327_c07YN_dA_w050_SQ_c7ebcut_9730_Donald_inferred-model-004_T2.ms',
            source_type = SourceType.MSCommand,
            IICR_type = IICRType.T_sim,
            ms_reference_size = 351.727,
        ...
        h_settings = Settings(
            ...
            custom_filename_tag = "".join(['val_rapport_verus_eb_c7w', str(w)]),
            output_directory = '~/snif/Chimps/val_rapport/verus_eb/',
