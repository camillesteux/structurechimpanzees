...
for i in [1, 2, 3]:
    for w in [0.5]:
        h_inference_parameters = InferenceParameters(
            data_source = '~/snif/Chimps/val_rapport/schwein_eb/230323-172956_c07YN_dA_w050_SQ_c7eb2_A911_Kidongo_inferred-model-007_T2.ms',
            source_type = SourceType.MSCommand,
            IICR_type = IICRType.T_sim,
            ms_reference_size = 723.009,
        ...
        h_settings = Settings(
            ...
            custom_filename_tag = "".join(['val_rapport_schwein_c7w', str(w)]),
            output_directory = '~/snif/Chimps/val_rapport/schwein_eb/',
