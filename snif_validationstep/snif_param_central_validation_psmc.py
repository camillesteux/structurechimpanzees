...
for c in [8]:
    for w in [0.5]:
        h_inference_parameters = InferenceParameters(
            data_source = ''.join(['~/snif/Chimps/val_psmc/input_data/230324-044130_c08YN_dA_w050_SQ_c8eb_A958_Doris_psmc_10x100Mb-', args.individual, '.psmc']),
            source_type = SourceType.PSMC,
            IICR_type = IICRType.Exact,
            ms_reference_size = 819,
        ...
        h_settings = Settings(
            ...
            custom_filename_tag = ''.join(['troglo_valpsmc_c', str(c), 'eb_w', str(w), '_', args.individual]),
        ...
        config = Configuration(
            ...
            CG_source = '~/snif/Chimps/val_psmc/input_data/230324-044130_c08YN_dA_w050_SQ_c8eb_A958_Doris_inferred-model-001.json',
